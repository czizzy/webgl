...
var FSHADER_SOURCE = getSource('multitexture.frag');
var img0 = getImage('../resources/redflower.jpg');
var img1 = getImage('../resources/circle.gif');
Promise.all([VSHADER_SOURCE, FSHADER_SOURCE, img0, img1]).then(function(sources) {
    ...
    // gl.texParameteri(gl.TEXTURE_2D, gl.TEXTURE_WRAP_S, gl.MIRRORED_REPEAT);
    // gl.texParameteri(gl.TEXTURE_2D, gl.TEXTURE_WRAP_T, gl.MIRRORED_REPEAT);
    gl.texImage2D(gl.TEXTURE_2D, 0, gl.RGB, gl.RGB, gl.UNSIGNED_BYTE, sources[3]);
